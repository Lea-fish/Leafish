...
use crate::{resources::Manager, ui::glow::render::Renderer};

use super::{BatchBuilder, BatchRef, Container, HAttach, ImageBuilder, TextBuilder, TextRef, VAttach};
...
impl Logo {
    pub fn new(
        ...
        let shadow_batch = BatchBuilder::new()
            .position(0.0, 8.0)
            .size(100.0, 100.0)
            .alignment(VAttach::Top, HAttach::Center)
            .create(ui_container);
        let layer0 = BatchBuilder::new()
            .position(0.0, 8.0)
            .size(100.0, 100.0)
            .draw_index(1)
            .alignment(VAttach::Top, HAttach::Center)
    ...
    pub fn tick(&mut self, renderer: &Arc<Renderer>) {
