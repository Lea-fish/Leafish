...
use crate::ui::glow::render::model;
use crate::world;
...
impl Info {
    ...
    pub fn update(&mut self, renderer: Arc<Renderer>, pos: Position, bl: block::Block) {
        ...
        let tex = Renderer::get_texture(renderer.get_textures_ref(), "leafish:solid");
