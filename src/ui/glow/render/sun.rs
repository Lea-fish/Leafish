...
use super::{model::{ModelHandle, Vertex, SUN}, Renderer};
...
impl SunModel {
    pub fn new(renderer: Arc<Renderer>) -> SunModel {
        SunModel {
    ...
    pub fn tick(&mut self, renderer: Arc<Renderer>, world_time: f64, world_age: i64) {
    ...
    pub fn generate_sun(renderer: Arc<Renderer>) -> ModelHandle {
        let tex = Renderer::get_texture(renderer.get_textures_ref(), "environment/sun");
    ...
    pub fn generate_moon(renderer: Arc<Renderer>, phase: i32) -> ModelHandle {
        let tex =
            Renderer::get_texture(renderer.get_textures_ref(), "environment/moon_phases");
