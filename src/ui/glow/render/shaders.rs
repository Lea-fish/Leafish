...
use super::glsl::Registry;

pub fn add_shaders(reg: &mut Registry) {
    reg.register(
        "lookup_texture",
...
macro_rules! init_shader {
    (
        ...
        #[allow(dead_code)]
        struct $name {
            program: crate::ui::glow::gl::Program,
            $(
                $field: crate::ui::glow::gl::Attribute,
            )*
            $(
                $ofield: Option<crate::ui::glow::gl::Attribute>,
            )*
            $(
                $ufield: crate::ui::glow::gl::Uniform,
            )*
            $(
                $oufield: Option<crate::ui::glow::gl::Uniform>,
            )*
        }

        impl $name {
            #[allow(dead_code)]
            pub fn new(reg: &crate::ui::glow::render::glsl::Registry) -> $name {
            ...
            pub fn new_manual(v: &str, f: &str) -> $name {
                let shader = crate::ui::glow::render::shaders::create_program(&v, &f);
                $name {
                    $(
...
pub fn create_program(vertex: &str, fragment: &str) -> crate::ui::glow::gl::Program {
    let program = crate::ui::glow::gl::Program::new();

    let v = crate::ui::glow::gl::Shader::new(glow::VERTEX_SHADER);
    v.set_source(vertex);
    v.compile();
    ...
    let f = crate::ui::glow::gl::Shader::new(crate::ui::glow::gl::FRAGMENT_SHADER);
