...
impl ChunkBuilder {
    ...
    pub fn tick(&mut self, world: Arc<World>, renderer: Arc<Renderer>, version: usize) {
        ...
        let dirty_sections = super::super::get_render_list(&tmp_world)
            .iter()
            .map(|v| v.0)
