...
use crate::ui::glow::render::hud::Hud;
use crate::ui::glow::render::inventory::InventoryWindow;
...
fn set_secondary_power(texture: String, basic_elements: &mut [ImageRef]) {
...
fn get_texture(element: usize, basic_elements: &[ImageRef]) -> String {
    basic_elements
        .get(element)
        .unwrap()
        .borrow()
...
fn get_button_state(btn: usize, basic_elements: &[ImageRef]) -> ButtonState {
    use ButtonState::*;
...
fn set_button_state(state: ButtonState, btn: usize, basic_elements: &mut [ImageRef]) {
    use ButtonState::*;
