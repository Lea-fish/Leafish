...
use crate::ui::glow::{render::{hud::Hud, inventory::InventoryWindow, Renderer}, ui::{Container, HAttach, ImageBuilder, TextBox, TextBoxBuilder, TextBuilder, VAttach}};

use super::{slot_mapping::SlotMapping, Inventory, InventoryType, Item};
...
impl Inventory for AnvilInventory {
    ...
    fn init(
        ...
        TextBox::make_focusable(inventory_window.text_box.last().unwrap(), ui_container);
