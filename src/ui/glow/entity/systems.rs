use self::player::PlayerMovement;

use super::*;
use crate::server::{ConnResource, InventoryContextResource, RendererResource, WorldResource};
use crate::shared::Position as BPos;
use crate::ui::glow::particle::block_break_effect::{BlockBreakEffect, BlockEffectData};
use crate::ui::glow::particle::ParticleType;
use crate::ui::glow::render::target::{test_block, trace_ray};
...
impl ApplyDigging<'_, '_> {
    ...
    fn start_digging(&mut self, state: &DiggingState, effect: &mut Option<Entity>) {
        ...
        entity.insert(ParticleType::BlockBreak);
