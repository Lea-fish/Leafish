use super::{player_like::compute_player_model_components, Bounds, GameInfo, Light, Position, Rotation};
use crate::{server::RendererResource, ui::glow::{entity::player_like::PlayerLikeModelPart, render::{model::{ModelHandle, DEFAULT}, Renderer}}};
